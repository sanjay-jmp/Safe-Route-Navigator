...
def _find_route_from_neo4j_data(source_lat, source_lon, dest_lat, dest_lon, time_bin, route_type, buffer_degrees=0.09):
    """
        ...
        try:
            ...
            with timeout(20):
                local_G, path_osmid_list, route_info = _find_route_from_neo4j_data(
                    ...
                    time_bin, route_type, buffer_degrees=0.08  # Reduced buffer for performance
                )
